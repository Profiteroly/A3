...
public class CadastroView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtUsuario.setBackground(new java.awt.Color(216, 217, 210));
        txtUsuario.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        txtUsuario.setForeground(new java.awt.Color(105, 99, 71));
        txtUsuario.setBorder(null);
        txtUsuario.setCaretColor(new java.awt.Color(105, 99, 71));
        txtUsuario.setDisabledTextColor(new java.awt.Color(105, 99, 71));
        txtUsuario.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtUsuarioActionPerformed(evt);
            }
        });
        jPanel2.add(txtUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(833, 363, 495, 59));
