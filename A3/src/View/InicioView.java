...
public class InicioView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField1.setBackground(new java.awt.Color(178, 171, 109));
        jTextField1.setFont(new java.awt.Font("Segoe UI Black", 0, 24)); // NOI18N
        jTextField1.setForeground(new java.awt.Color(255, 240, 188));
        jTextField1.setText("Bem-Vindo(a) Fulana de tal!");
        ...
        jPanel1.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 100, 600, 90));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/inicio.png"))); // NOI18N
        jLabel1.setText("jLabel1");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1920, -1));

        jTextField3.setBackground(new java.awt.Color(178, 171, 109));
        jTextField3.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jTextField3.setForeground(new java.awt.Color(255, 240, 188));
        jTextField3.setText("Bem-Vindo(a) Fulana de tal!");
        ...
        jPanel1.add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 100, 600, 90));
    ...
    private void buttonDescarteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonDescarteActionPerformed
       DescarteView teladedescarte = new DescarteView();
       teladedescarte.setVisible(true);
       dispose();
