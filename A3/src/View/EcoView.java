 ...
 * @author Maysa
 */
public class EcoView extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EcoView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
